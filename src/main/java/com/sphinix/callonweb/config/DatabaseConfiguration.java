package com.sphinix.callonweb.config;

import com.sphinix.callonweb.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.sphinix.callonweb.repository")
...
public class DatabaseConfiguration {
    ...
    public DataSource dataSource(DataSourceProperties dataSourceProperties, JHipsterProperties jHipsterProperties, CacheManager cacheManager) {
        ...
        if (dataSourceProperties.getUsername() != null) {
            ...
            config.addDataSourceProperty("user", "root"); // HikariCP doesn't allow null user
        }
        if (dataSourceProperties.getPassword() != null) {
            config.addDataSourceProperty("password", dataSourceProperties.getPassword());
        } else {
            config.addDataSourceProperty("password", "mysql"); // HikariCP doesn't allow null password
        }
